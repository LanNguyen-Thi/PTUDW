...
module.exports = {
    ...
    async myCourses(idHocVien) {
        ...
        from khoahoc k, hocvien_mua_khoahoc h, giangvien g 
    ...
    async buyCourse(entity) {
        return db.add(entity, 'hocvien_mua_khoahoc')
        },
    async allmycourse(idGiangVien)
    {
        return db.load(`select * from khoahoc kh where kh.NguoiTao = ${idGiangVien} or kh.NguoiDay=${idGiangVien}`);
    }   
}
